...
class CategoryPagingSource (private val preferences: SessionPreferences, private val apiService: ApiService, private val category: String) : PagingSource<Int, ProductItem>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ProductItem> {
        return try {
            ...
            if (token.isEmpty()) {
                ...
                val responseData = apiService.getProductByCategory(token,category, page, params.loadSize)
